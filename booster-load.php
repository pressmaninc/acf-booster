			...
			array(
				...
				'fields'                => array(
					array(
						...
						'name'              => 'word-list',
						'type'              => 'textarea',
						'instructions'      => __( 'Write NG words separated by commas.', 'acf-booster' ),
						'required'          => 0,
						'conditional_logic' => 0,
						'wrapper'           => array(
							'width' => '',
		...
		array(
			...
			'fields'                => array(
				array(
					...
					'acfe_permissions'  => '',
					'message'           => __( 'Add the ability to set prohibited characters in custom fields', 'acf-booster' ),
					'default_value'     => 0,
					'ui'                => 1,
					'ui_on_text'        => 'Enable',
					'ui_off_text'       => 'Disable',
				...
				array(
					...
					'acfe_permissions'  => '',
					'message'           => __( 'Add a character counter to the custom field input screen', 'acf-booster' ),
					'default_value'     => 0,
					'ui'                => 1,
					'ui_on_text'        => 'Enable',
					'ui_off_text'       => 'Disable',
